...
class TestPlanetPopulation(unittest.TestCase):
    ...
    def test_gen_w(self):
        ...
        np.testing.assert_allclose(resmin.value, v[0], rtol=1e-02, atol=0.5)
        np.testing.assert_allclose(resmax.value, v[1], rtol=1e-02, atol=0.5)
        np.testing.assert_allclose(resmean.value, vmean, rtol=1e-02, atol=1.)
    ...
    def test_gen_radius(self):
        ...
        np.testing.assert_allclose(resmin, vmin, rtol=1e-02, atol=0.)
        np.testing.assert_allclose(resmax, vmax, rtol=1e-02, atol=0.)
        np.testing.assert_allclose(resmean, vmean, rtol=1e-02, atol=0.)
