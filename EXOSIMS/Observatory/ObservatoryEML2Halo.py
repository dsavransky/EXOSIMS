...
class ObservatoryL2Halo(Observatory):
    ...
    code with inputs from from E. Zimovan (2017).  Describes halo orbits
    which are then patched for the entire mission duration).
    ...
    def equationsOfMotion_CRTBP(self,t,state):
        ...
        All parameters are normalized so that time = 2*pi period.
        Distances are normalized to the distance between the two primaries.
        Coordinates are taken in a rotating
        ...
        TU = 3.751903E+5*u.s                    #time unit
        DU = (3.844000E+5*u.km).to('m')         #distance unit
        MU = 6.046804E+24*u.kg                  #mass unit = m1+m2
