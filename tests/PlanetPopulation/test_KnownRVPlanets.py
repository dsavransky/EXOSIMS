...
significant_planets = [
    (1, '55_Cnc_d',       '55 Cnc',    0.424, 2.9E-09, 0.36, 0.43, 0.08, 5.96, 3.54, 14.1, 4909, 5.47),
    (2, 'mu_Ara_c',       'HD 160691', 0.329, 3.1E-09, 0.10, 0.06, 0.02, 5.12, 1.89, 14.2, 4206, 5.34),
    (3, 'HD_217107_c',    'HD 217107', 0.257, 3.1E-09, 0.45, 0.24, 0.09, 6.17, 2.62, 14.2, 4270, 5.33),
    (4, 'HD_114613_b',    'HD 114613', 0.245, 2.6E-09, 0.09, 0.05, 0.02, 4.85, 0.51, 12.9, 3827, 5.31),
    (5, '47_UMa_c',       '47 UMa',    0.243, 5.9E-09, 0.04, 0.02, 0.01, 5.03, 0.55, 13.2, 2391, 3.57),
    (6, 'HD_190360_b',    'HD 190360', 0.239, 5.6E-09, 0.10, 0.05, 0.02, 5.73, 1.54, 14.2, 2915, 3.97),
    (7, 'HD_154345_b',    'HD 154345', 0.216, 4.9E-09, 0.59, 0.30, 0.10, 6.76, 0.96, 14.1, 3342, 4.21),
    (8, 'HD_134987_c',    'HD 134987', 0.212, 2.5E-09, 1.16, 0.57, 0.18, 6.47, 0.80, 13.9, 5000, 5.83),
    (9, 'HD_87883_b',     'HD 87883',  0.188, 6.9E-09, 1.45, 0.57, 0.19, 7.57, 1.76, 14.2, 2754, 3.58),
    (10, 'upsilon_And_d', 'ups And',   0.179, 1.3E-08, 0.01, 0.00, 0.00, 4.10, 4.12, 14.0, 1278, 2.52),
    (11, 'HD_39091_b',    'HD 39091',  0.175, 5.3E-09, 0.13, 0.06, 0.02, 5.65,10.09, 11.7, 2151, 3.35),
    (12, 'beta_Gem_b',    'HD 62509',  0.162, 2.8E-08, 0.00, 0.00, 0.00, 1.15, 2.76, 14.2,  590, 1.76),
    (13, '14_Her_b',      '14 Her',    0.159, 9.5E-09, 0.25, 0.12, 0.03, 6.61, 5.22, 13.6, 1773, 2.93),
    (14, '47_UMa_b',      '47 UMa',    0.143, 2.0E-08, 0.02, 0.01, 0.00, 5.03, 2.55, 14.2, 1078, 2.10),
    (15, 'gamma_Cep_b',   'gam Cep',   0.134, 2.2E-08, 0.00, 0.00, 0.00, 3.21, 1.52, 14.2,  906, 1.98),
    ]
...
class TestKnownRVPlanetsMethods(unittest.TestCase):
    ...
    @unittest.skip('skipping init - traub')
    ...
    #@unittest.skip('skipping init test, comparison')
