...
path_f1 = os.path.normpath(os.path.expandvars("$HOME/Documents/Research/testFilesActa/filesLunarSSL1S.txt"))
f1 = open(path_f1, "r")
...
for jj in f1:
    ...
    for occSep_p in d:
        ...
        Obs = SotoStarshadeMoon(**{
          "seed": 968390887, \
          "missionLife": 5.0, \
          "missionStart": 64681+2.055+1+2.555+1, \
          "missionPortion": 0.5, \
          "GAPortion_SS": 0.5, \
          ...
          "nmax_promo_det": 3, \
          "occ_dtmax":dtMax, \
          "cachedir": "$HOME/.EXOSIMS/cache_lunarSSL1S_12172024_41", \
