...
\begin{figure}[ht]
    \begin{center}
        \begin{tabular}{c}
             \includegraphics[width=0.9\textwidth]{codeflow3}
        \end{tabular}
    \end{center}
...
\begin{itemize}
    ...
    \begin{description}
        ...
        \begin{description}
            ...
            Maximum eccentricity. Default value is 0.999.
            ...
            Minimum planetary albedo. Default value is 0.0004.
            \item specs["p\_max"] \hfill \\
            Maximum planetary albedo. Default value is 0.6.
            \item specs["I\_min"] \hfill \\
            Minimum inclination in degrees. Default value is 0.
            \item specs["I\_max"] \hfill \\
            Maximum inclination in degrees. Default value is 360.
...
\begin{itemize}
    ...
    \begin{description}
        ...
        \begin{description}
            ...
            Optical system throughput. Callable object with arguments of wavelength, valid between the lowest and highest wavelengths to be observed, and angular separation, valid between the IWA and OWA.  For a fixed throughput, the callable object may always return a single value.  Default returns a single value of 0.5.
            \item specs["contrast"] \hfill \\
            Optical system contrast.  Callable object with arguments of wavelength, valid between the lowest and highest wavelengths to be observed, and angular separation, valid between the IWA and OWA.  For a fixed contrast, may always return a single value.  Default returns a single value of 1e-10.
            \item specs["dr"] \hfill \\
            ...
            Optical system overhead time.  Default value is 1 day.
            \item specs["darkHole"] \hfill \\
            Dark hole size in radians.  Default value is $ \pi $ rad.
        \end{description}
    \end{description}
\end{itemize}
...
\begin{itemize}
    ...
    \begin{description}
        ...
        \begin{description}
            ...
            String containing name of desired Planet Population module. Default is Planet Population prototype module.
    ...
    \begin{description}
        ...
        Information from simulation specification JSON file organized into a Python dictionary. If the below key: value pairs are missing from the dictionary, the Target List object attributes will be assigned the default values listed.
            \begin{description}
                ...
                String containing name of desired Star Catalog module. Default is Star Catalog prototype module.
                \item specs["optsysname"] \hfill \\
                String containing name of desired Optical System module. Default is Optical System prototype module.
                ...
                String containing name of desired Zodiacal Light module. Default is Zodiacal Light prototype module.
    ...
    \begin{description}
        ...
        Information from simulation specification JSON file organized into a Python dictionary. If the below key: value pairs are missing from the dictionary, the Simulated Universe object attributes will be assigned the default values listed.
            \begin{description}
                ...
                String containing name of desired Target List module. Default is Target List prototype module.
                \item specs["planphysname"] \hfill \\
                String containing name of Planet Physical Model module. Default is Planet Physical Model prototype module.
            \end{description}
        \item[OpticalSys] \hfill \\
...
\begin{itemize}
    ...
    \begin{description}
        ...
        1D NumPy ndarray containing planet albedos determined from \verb+planet_albedos()+ ~\ref{sec:planetalbedostask}
        ...
        1D NumPy ndarray containing list of rock/ice fraction for rocky/icy planets determined from \verb+planet_rtypes()+ ~\ref{sec:planetrtypestask}
    ...
    \begin{description}
        ...
        Information from simulation specification JSON file organized into a Python dictionary. If the below key: value pairs are missing from the dictionary, the Survey Simulation object attributes will be assigned the default values listed.
            \begin{description}
                ...
                String containing name of desired Simulated Universe module. Default is Simulated Universe prototype module.
                \item specs["obsname"] \hfill \\
                String containing name of Observatory module. Default is Observatory prototype module.
                \item specs["timename"] \hfill \\
                String containing name of Time Keeping module. Default is Time Keeping prototype module
                \item specs["ppname"] \hfill \\
                String containing name of Post-Processing module. Default is Post-Processing prototype module
            \end{description}
        \item[OpticalSys] \hfill \\
