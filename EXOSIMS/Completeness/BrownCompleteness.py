...
class BrownCompleteness(Completeness):
    ...
    def __init__(self, Nplanets=1e8, **specs):
        ...
        self.filename = self.PlanetPopulation.__class__.__name__ + self.PlanetPhysicalModel.__class__.__name__ + self.__class__.__name__ + str(self.Nplanets) + specs["whichPlanetPhaseFunction"]
