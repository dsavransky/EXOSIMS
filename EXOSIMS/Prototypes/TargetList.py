...
class TargetList(object):
    ...
    * PostProcessing
    ...
    def stellar_mass(self):
            ...
            elif self.massLuminosityRelationship =="Fernandes2021": #only good for FGK
            ...
            elif self.massLuminosityRelationship =="Henry1993+1999": #more specific than Henry1993
            ...
            elif self.massLuminosityRelationship == "Fang2010":  # for all main sequence stars, good generalist
                self.MsEst = np.array([])
                for MV in self.MV:
                    if MV <= 1.05:
