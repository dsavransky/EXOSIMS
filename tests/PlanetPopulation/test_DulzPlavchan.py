...
class TestDulzPlavchan(unittest.TestCase):
    ...
    def test_gen_plan_params(self):
        ...
        self.assertEqual(len(a), num, 'Incorrect number of samples generated for DulzPlavchan')
        self.assertTrue(np.all(a <= obj.arange[1]), 'a high bound failed for DulzPlavchan')
        self.assertTrue(np.all(a >= obj.arange[0]), 'a low bound failed for DulzPlavchan')
        self.assertEqual(len(e), num, 'Incorrect number of samples generated for DulzPlavchan')
        self.assertTrue(np.all(e <= obj.erange[1]), 'e high bound failed for DulzPlavchan')
        self.assertTrue(np.all(e >= obj.erange[0]), 'e low bound failed for DulzPlavchan')
        self.assertEqual(len(p), num, 'Incorrect number of samples generated for DulzPlavchan')
        self.assertTrue(np.all(p <= obj.prange[1]), 'p high bound failed for DulzPlavchan')
        self.assertTrue(np.all(p >= obj.prange[0]), 'p low bound failed for DulzPlavchan')
        self.assertEqual(len(Rp), num, 'Incorrect number of samples generated for DulzPlavchan')
        self.assertTrue(np.all(Rp <= obj.Rprange[1]), 'Rp high bound failed for DulzPlavchan')
        self.assertTrue(np.all(Rp >= obj.Rprange[0]), 'Rp low bound failed for DulzPlavchan')
